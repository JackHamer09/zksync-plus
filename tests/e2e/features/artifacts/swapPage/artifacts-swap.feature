...
Feature: Artifacts - UI - Swap
  ...
  Scenario: Check artifacts for the Swap page
    ...
    Then Element with "partial href and text" "'https://syncswap.xyz/' and 'Syncswap'" should be "visible"
    Then Element with "partial href and text" "'https://syncswap.xyz/' and 'Syncswap'" should be "clickable"
    Then Element with "partial src" "/img/syncswap.svg" should be "visible"
    Then Element with "partial src" "/img/syncswap.svg" should be "clickable"
